...
export default function RegisterPage() {
  ...
  async function handleGoogleLogin() {
    ...
    await supabase.auth.signInWithOAuth({
      provider: "google",
      options: {
        redirectTo: "https://doggram-blush.vercel.app/auth/callback",
      },
    });
  }
    ...
    <>
      ...
      <div className="bg-doggram-warm-white border border-doggram-border rounded-3xl shadow-warm-md p-6">
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-3 py-3 px-4 rounded-2xl border-2 border-doggram-border bg-doggram-surface hover:border-doggram-orange/40 transition-colors font-semibold text-sm text-doggram-brown-dark disabled:opacity-60"
        >
